...
function App() {
  const employeeList = [
    {
        img: 'https://img.freepik.com/premium-photo/3d-user-illustration_541443-3647.jpg',
        name: 'James King',
  ...
  return <div className='app'>
    <HomePage employeeList={employeeList} setCurrentImloyee={handleSetCurrentEmployee}/>
